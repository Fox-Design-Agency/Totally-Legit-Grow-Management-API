...
const (
	...
	GET_GROWING_MEDIUM_BY_ID_SQL = GET_GROWING_MEDIUM_BASE_SQL + `
		WHERE growing_mediums.id = $1
		`

	GET_ALL_GROWING_MEDIUM_SQL = GET_GROWING_MEDIUM_BASE_SQL
)
