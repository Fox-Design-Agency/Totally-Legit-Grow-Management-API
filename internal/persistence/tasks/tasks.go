...
func (db *TaskPersistence) CreateTask(req *routemodels.CreateTaskRequest) (*routemodels.CreateTaskResponse, error) {
	/**********************************************************************
	/
...
func (db *TaskPersistence) DeleteTask(req *routemodels.DeleteTaskRequest) error {
	/**********************************************************************
	/
	/	State Stuff to Return
	/
...
func (db *TaskPersistence) EditTask(req *routemodels.EditTaskRequest) (*routemodels.EditTaskResponse, error) {
	/**********************************************************************
	/
	/	State Stuff to Return
	/
...
func (db *TaskPersistence) GetTask(req *routemodels.GetTaskRequest) (*routemodels.GetTaskResponse, error) {
	/**********************************************************************
	/
	/	State Stuff to Return
	/
...
func (db *TaskPersistence) GetAllTasks(req *routemodels.GetAllTasksRequest) (*routemodels.GetAllTasksResponse, error) {
	/**********************************************************************
	/
	/	State Stuff to Return
	/
