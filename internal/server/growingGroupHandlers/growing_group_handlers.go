...
func (s *GrowingGroup) CreateGrowingGroup(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingGroup) DeleteGrowingGroup(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingGroup) EditGrowingGroup(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingGroup) GetGrowingGroup(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingGroup) GetAllGrowingGroups(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
