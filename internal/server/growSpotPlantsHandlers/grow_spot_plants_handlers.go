...
func (s *GrowSpotPlants) CreateGrowSpotPlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// CreateGrowSpotPlant will handle the initial request and then send the formed request
// to the logic layer before returning the request
func (s *GrowSpotPlants) DeleteGrowSpotPlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowSpotPlants) EditGrowSpotPlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowSpotPlants) GetGrowSpotPlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowSpotPlants) GetAllGrowSpotPlants(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
