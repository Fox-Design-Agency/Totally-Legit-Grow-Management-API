...
// to the logic layer before returning the request
func (s *GrowingMedium) DeleteGrowingMedium(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingMedium) GetGrowingMedium(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *GrowingMedium) GetAllGrowingMediums(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
