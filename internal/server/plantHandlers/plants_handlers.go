...
func (s *Plant) CreatePlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *Plant) DeletePlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *Plant) GetPlant(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *Plant) GetAllPlants(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
