...
func (s *PlantLifeCycle) CreatePlantLifeCycle(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *PlantLifeCycle) DeletePlantLifeCycle(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *PlantLifeCycle) EditPlantLifeCycle(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
...
// to the logic layer before returning the request
func (s *PlantLifeCycle) GetPlantLifeCycleByID(w http.ResponseWriter, r *http.Request) {
	/**********************************************************************
	/
	/	Start Telemetry
	/
