...
func (lg *ProductControl) CreateProduct(req *routemodels.CreateProductRequest) (*routemodels.CreateProductResponse, error) {
	/**********************************************************************
	/
...
func (lg *ProductControl) DeleteProduct(req *routemodels.DeleteProductRequest) error {
	/**********************************************************************
	/
	/	Run Validation Checks
	/
...
func (lg *ProductControl) EditProduct(req *routemodels.EditProductRequest) (*routemodels.EditProductResponse, error) {
	/**********************************************************************
	/
	/	Run Validation Checks
	/
...
// Product
func (lg *ProductControl) GetProduct(req *routemodels.GetProductRequest) (*routemodels.GetProductResponse, error) {
	/**********************************************************************
	/
	/	Run Validation Checks
	/
...
// Products
func (lg *ProductControl) GetAllProducts(req *routemodels.GetAllProductsRequest) (*routemodels.GetAllProductsResponse, error) {
	/**********************************************************************
	/
	/	Run Validation Checks
	/
