...
// CreateGrowingLevel will handle the initial request and then send the formed request
...
func (s *Server) CreateGrowingLevel(w http.ResponseWriter, r *http.Request) {
	...
	/
	/**********************************************************************/
	resp, err := s.Logic.CreateGrowingLevel(&form)
	if err != nil {
...
// DeleteGrowingLevel will handle the initial request and then send the formed request
// to the logic layer before returning the request
func (s *Server) DeleteGrowingLevel(w http.ResponseWriter, r *http.Request) {
	...
	/
	/**********************************************************************/
	err := s.Logic.DeleteGrowingLevel(&form)
	if err != nil {
		helpers.SendErrorHeader(w, http.StatusBadRequest, nil)
		return
	}
...
// EditGrowingLevel will handle the initial request and then send the formed request
// to the logic layer before returning the request
func (s *Server) EditGrowingLevel(w http.ResponseWriter, r *http.Request) {
	...
	/
	/**********************************************************************/
	resp, err := s.Logic.EditGrowingLevel(&form)
	if err != nil {
		helpers.SendErrorHeader(w, http.StatusBadRequest, nil)
		return
	}
...
// GetGrowingLevel will handle the initial request and then send the formed request
// to the logic layer before returning the request
func (s *Server) GetGrowingLevel(w http.ResponseWriter, r *http.Request) {
	...
	/
	/**********************************************************************/
	resp, err := s.Logic.GetGrowingLevelByID(&form)
	if err != nil {
		helpers.SendErrorHeader(w, http.StatusBadRequest, nil)
		return
	}
...
// GetAllGrowingLevels will handle the initial request and then send the formed request
// to the logic layer before returning the request
func (s *Server) GetAllGrowingLevels(w http.ResponseWriter, r *http.Request) {
	...
	/
	/**********************************************************************/
	resp, err := s.Logic.GetAllGrowingLevelsByGrowingLocationID(&form)
	if err != nil {
		helpers.SendErrorHeader(w, http.StatusBadRequest, nil)
		return
	}
